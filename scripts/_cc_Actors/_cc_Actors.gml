function _cc_Actors() {
	...
	game_actors[Actors.no]=newActor("No Actor", "Nothing to see here.", null_cutscene, Races.inanimate, true, false);
	game_actors[Actors.playable]=newActor("Player", "That's you!", null_cutscene, Races.inanimate, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_talk, "Left: New Game\nRight: Continue Game"));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.title]=newActor("Helpful Signpost", "Helps you start the game.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.new_game] = newActor("New Game", "Starts a new game.", l, Races.inanimate, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.load]=newActor("Continue Game", "Continues your saved game.", l, Races.inanimate, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_cutscene_set, Actors.playable, "gameover", false));
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	// @todo play game over music clip?
	ds_list_add(l, args(scr_fade_to_black));
	ds_list_add(l, args(scr_coc, Title));
	ds_list_add(l, args(scr_move_to, Actors.playable, 25, 32));
	ds_list_add(l, args(scr_fade_from_black));
	ds_list_add(l, args(scr_restore_health_full, Actors.playable));
	ds_list_add(l, args(scr_restore_magicka_full, Actors.playable));
	ds_list_add(l, args(scr_restore_stamina_full, Actors.playable));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	ds_list_add(l, args(scr_cutscene_set, Actors.playable, "default", true));
	game_actors[Actors.playable].cutscenes[? "gameover"]=l;

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_fade_to_black));
	ds_list_add(l, args(scr_restart));
	ds_list_add(l, args(scr_move_to, Actors.playable, 10, 7));
	ds_list_add(l, args(scr_fade_from_black));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.return_to_title]=newActor("Return to Title", "Restart the game.", l, Races.inanimate, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_fade_to_black));
	ds_list_add(l, args(scr_quit))
	game_actors[Actors.quit]=newActor("Quit Game", "Stop playing.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.Container]=newActor("Container", "A container with things in it.", l, Races.inanimate, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_show_inventory, Actors.ContainerBeer));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.ContainerBeer]=newActor("Container", "A container that's for holding large quantities of beer.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.ContainerWaterWalking]=newActor("Container", "A container with things in it.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.ContainerCandlelight]=newActor("Container", "A container with things in it.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.ContainerSparks]=newActor("Container", "A container with things in it.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.ContainerSTWeapons]=newActor("Container", "A container with things in it.", l, Races.inanimate, true, false);

	AddItem(Actors.ContainerSTWeapons, Items.iron_sword, 1);
	AddItem(Actors.ContainerSTWeapons, Items.dwarven_sword, 1);
	AddItem(Actors.ContainerSTWeapons, Items.leather_armor, 1);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.Sign]=newActor("Signpost", "A sign to lead you towards the Flower Fields.", l, Races.inanimate, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_talk_var, Actors.Tombstone));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.Tombstone]=newActor("Tombstone", "Dead people are buried under these things.", l, Races.inanimate, true, false);
	...
	game_actors[Actors.Teleport]=newActor("Teleporter", "Teleports to various places.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	game_actors[Actors.bedroll]=newActor("Bedroll", "You can sleep if you want to.", l, Races.inanimate, true, false);
	...
	ds_list_add(l, args(scr_do_if, scr_GetMultiChoiceAnswer, Misc.equals, 0, scr_add_active_effect, AllEffects.Waterwalking, Actors.playable, true, 60));
	...
	ds_list_add(l, args(scr_add_active_effect, AllEffects.ResistFire, Actors.playable, 1.5, 60));
	...
	ds_list_add(l, args(scr_battle, Actors.BattlerTest, Actors.playable));
	...
	//AddItem(Actors.BattlerTest, Items.dwarven_greatsword, 1);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_lock_set, Actors.TestDaedraFire));
	ds_list_add(l, args(scr_talk, "*atronach noises*", Actors.BattlerTest, Actors.TestDaedraFire));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	ds_list_add(l, args(scr_lock_unset, Actors.TestDaedraFire));
	game_actors[Actors.TestDaedraFire]=newActor("Flame Atronach", "The default flame atronach (Daedra Fire).", l, Races.daedra_fire, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_lock_set, Actors.TestSkeever));
	ds_list_add(l, args(scr_talk, "*skeever noises*", Actors.BattlerTest, Actors.TestSkeever));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	ds_list_add(l, args(scr_lock_unset, Actors.TestSkeever));
	game_actors[Actors.TestSkeever]=newActor("Skeever", "The default Skeever.", l, Races.skeever, true, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_lock_set, Actors.conjouration1));
	ds_list_add(l, args(scr_talk, ". . .", Actors.BattlerTest, Actors.conjouration1));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	ds_list_add(l, args(scr_lock_unset, Actors.conjouration1));
	game_actors[Actors.conjouration1]=newActor("Conjouration", "A conjouration.", l, Races.daedra_fire, false, false);

	var l=ds_list_create();
	ds_list_add(l, args(scr_lock_set, Actors.playable));
	ds_list_add(l, args(scr_lock_set, Actors.conjouration2));
	ds_list_add(l, args(scr_talk, ". . .", Actors.BattlerTest, Actors.conjouration2));
	ds_list_add(l, args(scr_lock_unset, Actors.playable));
	ds_list_add(l, args(scr_lock_unset, Actors.conjouration2));
	game_actors[Actors.conjouration2]=newActor("Conjouration", "A conjouration.", l, Races.daedra_fire, false, false);
