...
all_effects[AllEffects.Waterwalking]=newEffect("Water Walking", "Allows the user to walk on the surface of water.", false, true, Misc.additive);							// strength: true/false
// Conjouration
all_effects[AllEffects.Banish]=newEffect("Banish", "Sends summoned Daedra up to level & back to Oblivion.", 0, 1, Misc.multiplicative);										// strength: max level
...
all_effects[AllEffects.Command]=newEffect("Command", "Summoned and rasied creatures up to level & are put under the user's control.", 0, 1, Misc.multiplicative);			// strength: max level
all_effects[AllEffects.Conjour]=newEffect("Conjour", "Counjours an ally up from nothingness.", 0, 1, Misc.multiplicative);													// strength: summon level
all_effects[AllEffects.FireySoulTrap]=newEffect("Firey Soul Trap", "Sets the target on fire, and soul traps them.", 0, 1, Misc.multiplicative);								// strength: amount of fire damage AND duration of soul trap effect
all_effects[AllEffects.Reanimate]=newEffect("Reanimate", "Resurrects dead corpses up to level & to fight alongside the user.", 0, 1, Misc.multiplicative);					// strength: max level
all_effects[AllEffects.SoulTrap]=newEffect("Soul Trap", "If the target dies, their soul is trapped in a Soul Gem.", 0, 1, Misc.multiplicative);								// strength: duration of effect
// Destruction
all_effects[AllEffects.AbsorbHealth]=newEffect("Absorb Health", "The user absorbs & points of health from the target.", 0, 1, Misc.multiplicative);							// strength: amount stolen
all_effects[AllEffects.AbsorbMagicka]=newEffect("Absorb Magicka", "The user absorbs & points of magicka from the target.", 0, 1, Misc.multiplicative);						// strength: amount stolen
all_effects[AllEffects.AbsorbStamina]=newEffect("Absorb Stamina", "The user absorbs & points of stamina from the target.", 0, 1, Misc.multiplicative);						// strength: amount stolen
all_effects[AllEffects.ChaosDamage]=newEffect("Chaos Damage", "Deals fire, ice and shock damage to the target. All at the same time.", 0, 1, Misc.multiplicative);			// strength: points of damage
...
all_effects[AllEffects.FireDamage]=newEffect("Fire Damage", "Deals & points of fire damage to the target.", 0, 1, Misc.multiplicative);										// strength: points of damage
all_effects[AllEffects.FrostDamage]=newEffect("Frost Damage", "Deals & points of frost damage to the target.", 0, 1, Misc.multiplicative);									// strength: points of damage
...
all_effects[AllEffects.ShockDamage]=newEffect("Shock Damage", "Deals & points of shock damage to the target.", 0, 1, Misc.multiplicative);									// strength: points of damge
