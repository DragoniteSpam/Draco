...
/*all_perks[Perks.ApprenticeRestoration]=newPerk("Apprentice Restoration", 
ds_list_add(sk.perks, all_perks[Perks.ApprenticeRestoration]);

all_perks[Perks.AdeptRestoration]=newPerk("Adept Restoration", 
ds_list_add(sk.perks, all_perks[Perks.AdeptRestoration]);

all_perks[Perks.ExpertRestoration]=newPerk("Expert Restoration", 
ds_list_add(sk.perks, all_perks[Perks.ExpertRestoration]);

all_perks[Perks.MasterRestoration]=newPerk("Master Restoration", 
ds_list_add(sk.perks, all_perks[Perks.MasterRestoration]);

all_perks[Perks.Recovery]=newPerk("Recovery", 
ds_list_add(sk.perks, all_perks[Perks.Recovery]);

all_perks[Perks.AvoidDeath]=newPerk("Avoid Death", 
ds_list_add(sk.perks, all_perks[Perks.AvoidDeath]);

all_perks[Perks.Regeneration]=newPerk("Regeneration", 
ds_list_add(sk.perks, all_perks[Perks.Regeneration]);

all_perks[Perks.Necromage]=newPerk("Necromage", 
ds_list_add(sk.perks, all_perks[Perks.Necromage]);

all_perks[Perks.Respite]=newPerk("Respite", 
ds_list_add(sk.perks, all_perks[Perks.Respite]);

all_perks[Perks.RestorationDualCasting]=newPerk("Restoration Dual Casting", 
ds_list_add(sk.perks, all_perks[Perks.RestorationDualCasting]);

all_perks[Perks.WardAbsorb]=newPerk("Ward Absorb", 
...
/*all_perks[Perks.ChampionsStance]=newPerk("Champion's Stance", 
